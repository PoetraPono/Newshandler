<div class="container" style="padding-right:6%">
    ...
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation"><a href="#example1-tab2" aria-controls="example1-tab2" role="tab" data-toggle="tab">Sent</a></li>
        <li role="presentation"><a href="#example1-tab3" aria-controls="example1-tab3" role="tab" data-toggle="tab">Approved</a></li>
         <li role="presentation"><a href="#example1-tab4" aria-controls="example1-tab4" role="tab" data-toggle="tab">Rejected</a></li>
                      ...
                      ?></center></td>
                        ...
                        <td>
                         <a href="<?=base_url()?>user/lihat_berita/<?php echo $u_key->idberita; ?>" type="submit" class="btn btn-default"><i class="fa fa-pencil"></i></a>
                          <a href="<?=base_url()?>user/update_status_send/<?php echo $u_key->idberita; ?>" type="submit" class="btn btn-default"><i class="fa fa-send"></i></a>
                         <a href="<?=base_url()?>user/delete_berita/<?php echo $u_key->idberita; ?>" type="submit" class="btn btn-default"><i class="fa fa-trash"></i> </a>
                        </td>
                      </tr>
                    <?php }?>
                </tbody>
