<div class="container" style="padding-right:6%">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#example1-tab1" aria-controls="example1-tab1" role="tab" data-toggle="tab">Saved</a></li>
        ...
        <li role="presentation"><a href="#example1-tab3" aria-controls="example1-tab3" role="tab" data-toggle="tab">Rejected</a></li>
         <li role="presentation"><a href="#example1-tab4" aria-controls="example1-tab4" role="tab" data-toggle="tab">Final</a></li>
     ...
     <div role="tabpanel" class="tab-pane fade in active" id="example1-tab1">
            <table id="list_berita_pending" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php foreach ($berita_list_pending as $u_key){ ?>
                      ...
                      if($sb==8){
                          echo "<img src='".base_url()."assets/lala.png'>";
                      ...
                      ?></td>
                        ...
                        <td>
                          <?php
                          $temphidden=""; $temphidden2="";
                          if($user['iduser']==$u_key->user_iduser){
                            $temphidden="hidden";
                          }elseif($user['iduser']!=$u_key->user_iduser){
                            $temphidden2="hidden";
                          }
                          ?>
                           <a href="<?=base_url()?>user/lihat_berita/<?php echo $u_key->idberita; ?>" type="submit" class="btn btn-default"><i class="fa fa-pencil"></i></a>
                         
                         <a href="<?=base_url()?>user/delete_berita/<?php echo $u_key->idberita; ?>" type="submit" class="btn btn-default <?php echo $temphidden2; ?>"><i class="fa fa-trash"></i> </a>
                        <a href="<?=base_url()?>user/update_status_send_wartawan/<?php echo $u_key->idberita; ?>" type="submit" class="btn btn-default "><i class="fa fa-send"></i></a>
                          <a  href="<?=base_url()?>user/update_status_approve/<?php echo $u_key->idberita; ?>" type="submit" class="btn btn-default"><i class="fa fa-check"></i></a>
                          <a href="<?=base_url()?>user/update_status_reject/<?php echo $u_key->idberita; ?>" type="submit" class="btn btn-default"><i class="fa fa-ban"></i></a>
                        </td>
                      </tr>
                    <?php }?>
                </tbody>
                ...
                <tbody>
                    <?php foreach ($berita_list_approved as $u_key){ ?>
                      ...
                      ?></td>
                        ...
                        <td><?php echo $u_key->time_edit; ?></td>
                        <td>
                          <a href="<?=base_url()?>user/download_berita/<?php echo $u_key->idberita; ?>" type="submit" class="btn btn-default"><i class="fa fa-download"></i></a>
                          <a href="<?=base_url()?>user/update_status_send_cw/<?php echo $u_key->idberita; ?>" type="submit" class="btn btn-default"><i class="fa fa-send"></i></a>
                           <a href="<?=base_url()?>user/update_status_reject/<?php echo $u_key->idberita; ?>" type="submit" class="btn btn-default"><i class="fa fa-ban"></i></a>
                           <a href="<?=base_url()?>user/update_status_final/<?php echo $u_key->idberita; ?>" type="submit" class="btn btn-default"><i class="fa fa-certificate"></i></a>
                        </td>
                      </tr>
                    <?php }?>
                </tbody>
                ...
                <tbody>
                   <?php foreach ($berita_list_rejected as $u_key){ ?>
                      ...
                      ?></td>
                        ...
                        <td><?php echo $u_key->time_edit; ?></td>
                        <td>
                          <a href="<?=base_url()?>user/approve_from_reject/<?php echo $u_key->idberita; ?>" type="submit" class="btn btn-default"><i class="fa fa-check"></i></a>
                        </td>                        
                      </tr>
                   <?php }?>
                </tbody>
        ...
        <div role="tabpanel" class="tab-pane fade" id="example1-tab4">
            <table id="list_berita_saved" class="table table-striped table-bordered table-condensed" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php foreach ($berita_list_final as $u_key){ ?>
                      <tr>
                      <td><?php
                          $st =  $u_key->status_read; 
                          if($st==0){
