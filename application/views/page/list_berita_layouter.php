<div class="container" style="padding-right:6%">
    <h3>List Berita Layouter</h3>
    <br>

    <!-- Nav tabs -->
    <ul class="nav nav-tabs" role="tablist" id="myTab">
        <li role="presentation" class="active"><a href="#example1-tab1" aria-controls="example1-tab1" role="tab" data-toggle="tab">Approved</a></li>
    ...
    <form name="form1" action="<?=base_url()?>admin/tampil_dari_tgl" method="post" enctype="multipart/form-data" style="width:40%; float:left">
      ...
      <div>
        ...
        <div role="tabpanel" class="tab-pane fade in active" id="example1-tab2">
