...
<head>
  ...
  <title>Jawa Pos Wartawan | News</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>wartawan</b>LTE</span>
    </a>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?=base_url()?>voice/ambil">Coba</a></li>
...
<script>
function play(){
      responsiveVoice.speak( "Kali ini kita akan belajar mengenal hewan. hewan diatas adalah gajah.","Indonesian Female",
      {
